...
---@alias Collect.Terminal.NotifyFun fun(index: integer?, total: integer?, match: Collect.Match?)
---@alias Collect.Terminal.FilterFun fun(match: Collect.Match): boolean?
...
---@field matches Collect.Match[] The list of matches.
...
---@field config Collect.Terminal.Config The terminal configuration.
...
---@param config Collect.Terminal.Config? The terminal config.
