...
---@class BuildTerm.MatchScanner: BuildTerm.Scanner
---@field pattern string The match string to scan for.
---@field groups string[] The names of the matched groups.
---@field postproc BuildTerm.PostProcFun A post-processing function.
local MatchScanner = {}
...
---@param postproc BuildTerm.PostProcFun? A post-processing function.
---@return BuildTerm.MatchScanner scanner The scanner.
