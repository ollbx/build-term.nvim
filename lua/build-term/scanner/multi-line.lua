...
---@class BuildTerm.MultiLineScanner: BuildTerm.Scanner
---@field lines [BuildTerm.Scanner] Scanners for each consecutive line.
...
---@param lines [BuildTerm.Scanner] Scanners for each consecutive line.
---@return BuildTerm.MultiLineScanner scanner The scanner.
