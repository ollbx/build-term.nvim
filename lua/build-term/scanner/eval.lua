...
---@alias BuildTerm.EvalFun fun(string): BuildTerm.MatchData?

---@class BuildTerm.EvalScanner: BuildTerm.Scanner
---@field eval BuildTerm.EvalFun The eval function.
local EvalScanner = {}
EvalScanner.__index = EvalScanner

---Creates a new lua eval scanner.
---@param eval BuildTerm.EvalFun The eval function.
---@return BuildTerm.EvalScanner scanner The scanner.
function M.new(eval)
	local scanner = {
		eval = eval,
	}
...
---@return [BuildTerm.Match] matches The found matches.
